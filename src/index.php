...
if (in_array($requestMethod, ["GET", "POST", "PUT", "DELETE", "OPTIONS"])) {
    ...
    if (isset($requestMethodArray['apiKey'])){
        $apiKey = $requestMethodArray['apiKey'];
    }  
    if (isset($requestMethodArray['apiToken'])){
        $apiToken = $requestMethodArray['apiToken'];
    }
    if (isset($requestMethodArray['apiFunctionName'])){
        $functionName = $requestMethodArray['apiFunctionName'];
    }
    if (isset($requestMethodArray['apiFunctionParams'])){
            $functionParams = $requestMethodArray['apiFunctionParams'];
    }
